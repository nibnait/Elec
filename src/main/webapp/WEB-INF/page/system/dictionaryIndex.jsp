...
<script language="javascript">
		...
		if (document.Form1.keyword.value == "jerrynew") {
			...
			Pub
					.submitActionWithForm(
							'Form2',
							'${pageContext.request.contextPath }/system/elecSystemDDLAction_edit.do',
							'Form1');							
	...
	function insertRows() {
		...
		$tdName
				.html("<input name=\"itemname\" type=\"text\" id=\""+tempRow+"\" size=\"45\" maxlength=25>");

		var $tdDel = $("<td align='center'></td>");
		$tdDel
				.html("<a href='javascript:delTableRow(\""
						+ tempRow
			...
			<TBODY>
				...
				<tr>
					...
					<td class="ta_01" align="left" width="30%" height=20
						id="newddlText"><input type="text" name="keywordname"
						maxlength="25" size=24></td>
					<td class="ta_01" align="right" width="35%"></td>
				</tr>
			...
			<tr>
				<td>
					<table cellspacing="0" cellpadding="1" rules="all"
						bordercolor="gray" border="1" id="dictTbl"
						...
						<tr
							...
							<td class="ta_01" align="center" width="20%" height=22
								background="${pageContext.request.contextPath }/images/tablehead.jpg">编号</td>
